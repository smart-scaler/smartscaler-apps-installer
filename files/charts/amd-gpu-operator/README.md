...
| controllerManager.manager.image.tag | string | `"v1.3.0"` | AMD GPU operator controller manager image tag |
...
| kmm.controller.manager.env.relatedImageSign | string | `"docker.io/rocm/kernel-module-management-signimage:v1.3.0"` | KMM signer image for signing driver image's kernel module with given key pairs within cluster |
...
| kmm.controller.manager.env.relatedImageWorker | string | `"docker.io/rocm/kernel-module-management-worker:v1.3.0"` | KMM worker image for loading / unloading driver kernel module on worker nodes |
...
| kmm.controller.manager.image.tag | string | `"v1.3.0"` | KMM controller manager image tag |
...
| kmm.webhookServer.webhookServer.image.tag | string | `"v1.3.0"` | KMM webhook image tag |
